...
class _DriverLoginScreenState extends State<DriverLoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // Firestore'dan şoför bilgisini kontrol et
      ...
      if (querySnapshot.docs.isEmpty) {
        // Şoför bulunamadı veya şifre yanlış
        if (mounted) {
      ...
      final licensePlate = driverData['licensePlate'] as String?;
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) => DriverHomeScreen(
              driverId: driverId,
              driverName: driverName ?? 'Şoför',
              licensePlate: licensePlate ?? 'Plaka Yok',
            ),
          ),
        );
      }
